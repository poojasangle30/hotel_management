...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar navbar-light top-navbar" role="navigation">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <li>
					...
					<li>
                        <a  class="active-menu" href="Admin_show-rooms.php"> Booked Rooms </a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
               ...
               $get_restaurants = "CALL sp_admin_get_booked_rooms";
										...
										while($row = mysqli_fetch_array($rest_results))
										{
											...
											if($id % 2 ==1 )
											{
                                                echo"<tr class='gradeC'>
                                                    ...
                                                    <th><button  class='printBill'><a href=Admin_Bill_Room.php?cid=".$row['cust_id']."&Name=".$row['cust_fname']."&lname=".$row['cust_lname']."&roomBID=".$row['room_booking_id']."&checkin=".$row['check_in']."&checkout=".$row['check_out']."&rtID=".$row['room_type_id']."> Pay Now <a> </button></th>
