...
?>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="dashboard_conference.php?cust_id=<?php echo $cust_id; ?>"><i class="fa fa-dashboard"></i> Booked Conference</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
               ...
               $get_conf = "CALL sp_get_booked_conference_by_cust_id('$cust_id')";
