    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home.php"> PAYMENT </a>
            </div>
        ...
        <div id="page-wrapper" >
               ...
               $getAllData = "CALL sp_admin_get_all_bills_for_checkout";
										...
										while($row = mysqli_fetch_array($rest_results))
										{
											...
											if($id % 2 ==1 )
											{
                                                echo"<tr class='gradeC'>
                                                    ...
                                                    <td>".$row['checkin']."</td>
                                                    <td>".$row['checkout']."</td>
                                                    <th><button  class='printBill'><a href=Admin_Pymt-showRooms-amenity.php?cid=".$row['cust_id']."&abbr=".$row['rest_abbr']."&BID=".$row['bookingID']."> Pay Now <a> </button></th>
