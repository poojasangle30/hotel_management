										...
										while($row = mysqli_fetch_array($rest_results))
										{
											...
											if($id % 2 ==1 )
											{
                                                echo"<tr class='gradeC'>
                                                    ...
                                                    <th><button  class='printBill'><a href=Admin_Bill_Rest.php?cid=".$row['cust_id']."&Name=".$row['cust_fname']."&lname=".$row['cust_lname']."&restID=".$row['rest_booking_ID']."> Pay Now <a> </button></th>
