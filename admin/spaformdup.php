...
<meta charset="utf-8">
  ...
  <body>
   ...
   <div class="plans-section" id="spa">
         <div class="container">

         <h2> Book your Luxury Spa massages and get relaxed at our hotel!</h2>
         <br>
         <h3>Spa Timings: Morning - 11:00 to 1:00 and Evening 18:00 to 20:00</h3>
         <br>
  <h5> You Earn '200' Loyalty Points on successfull Login and Booking</h5>
  <br>
  ...
  <table align="center"> 
    <tr>
      <div class ="col-lg-3"></div>
        ...
        <td>
          <input type="text" class="datepicker" name="date" id="bdate" placeholder ="yyyy-mm-dd">    
        </td>
        </tr>
      </div>
     <tr>
          ...
          <td>
            <select name ="time" id="bdate" class="form-control mt-4 ml-2">
        ...
        <td>
          <br>
         <h4> Type of Massage*: </h4>
        </td>
        <td>
          <select name="spa_massage_type" class="form-control mt-4 ml-2" id="spa_massage_type" required>
            <option value='0'>Select Massage Type</option>
            <?php 
            $result3 = mysqli_query($user->db,"CALL sp_get_spa_massage_type");
            while($spa_massage_type  = mysqli_fetch_array($result3))
            {
                echo "<option value='".$spa_massage_type['spa_massage_type_id']."'>".$spa_massage_type['spa_massage_type']."</option>";
            }
            $user->db->next_result();
            ?>        
          </select>
          <!-- <select name="tspa" id="bdate" class="form-control" required>
                  <option value selected ></option>
                  <option value="Deep Tissue Massage">Deep Tissue Massage</option>
                  <option value="Healing Hot Stone Massage">Healing Hot Stone Massage</option>
                  <option value="Soothing Foot Therapy">Soothing Foot Therapy</option>
                  <option value="Soothing Foot Therapy">Aroma Massage Therapy</option>
                </select> -->
            </td>
        </tr>
      <tr>
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST')
        {
          ...
          { 
             ...
             { 
                  ...
                  $reservespa="CALL sp_get_booked_spa_count('$date', '$time')";
                  $result = mysqli_query($user->db, $reservespa);
                  ...
                  if($get_count) {
                    echo '<script>toastr.error("Spa is full please select another date and time")</script>'; 
                  }else {
                    $textmsg = "Slot is available, Login and Book Now!!";
                    echo "<a href='Confirm-Spa.php?&DT=".urlencode($date)."&time=".$time."&spa_massage_type=".($spa_massage_type)."'> <button class='btn btn-primary btn-block'>$textmsg </button></a>";
                   } 
                }
                else{
...
<div class="priceing-table-main">
         <div class="col-md-3 price-grid">
          <div class="price-block agile">
            <div class="price-gd-top">          
                      <img src="images/spa1.jpg" alt=" " class="img-responsive" /> 
                      <br>
        ...
        <div class="col-md-3 price-grid ">
          <div class="price-block agile">
            <div class="price-gd-top">
            <img src="images/spa2.jpg" alt=" " class="img-responsive" />
              <h3>Healing Hot Stone Massage</h3>
            </div>
            <div class="price-gd-bottom">
              <div class="price-list">
                  <ul>
        ...
        <div class="col-md-3 price-grid lost">
          <div class="price-block agile">
            <div class="price-gd-top">
            <img src="images/spa3.jpg" alt=" " class="img-responsive" />
              <h3>Soothing Foot Therapy</h3>
            </div>
            <div class="price-gd-bottom">
              <div class="price-list">
                <ul>
        ...
        <div class="col-md-3 price-grid lost">
          <div class="price-block agile">
            <div class="price-gd-top">
            <img src="images/spa4.jpg" alt=" " class="img-responsive" />
              <h3>Aroma Massage Therapy</h3>
            </div>
            <div class="price-gd-bottom">
              <div class="price-list">
                <ul>
