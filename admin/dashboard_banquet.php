...
?>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="dashboard_banquet.php?cust_id=<?php echo $cust_id; ?>"><i class="fa fa-dashboard"></i> Booked Banquets</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
               ...
               $get_banquets = "CALL sp_get_booked_banquets_by_cust_id('$cust_id')";
               $banq_results = mysqli_query($user->db,$get_banquets);
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <tbody>    
									<?php
										while($row = mysqli_fetch_array($banq_results))
										{										
