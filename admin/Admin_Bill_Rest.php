...
<form method ="POST" action="">
 ...
 <label for="subject">Restaurant Bill</label>
 <input  style="width:90%"  class="restbill" name="restbill" type="number"></input>
 </div>
               ...
               if($custloyalty > $fetchPoint[0]){
                ...
                if($restbill){
                  ...
                  $finalBill = $finalBillwtax - $discount;
                   ...
                   echo " <br>
                   <a href=Print_Rest-Bill.php?cid=".$cid."&restamount=".$restbill."&loyalty=".$custloyalty."&tax=".$tax."&discount=".$discount."&finalBill=".$finalBill."><button class='btn btn-block btn-secondary'> Print Bill</button> <a>";
                  }else{
