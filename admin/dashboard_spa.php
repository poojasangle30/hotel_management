...
?>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"  href="dashboard_spa.php?cust_id=<?php echo $cust_id; ?>"><i class="fa fa-dashboard"></i> Booked Spa</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
               ...
               $get_conf = "CALL sp_get_booked_spa_by_cust_id('$cust_id')";
               $conf_results = mysqli_query($user->db,$get_conf);
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <tbody>    
									<?php
										while($row = mysqli_fetch_array($conf_results))
										{										
                                            ...
                                            <td>".$row['spa_time']."</td>
                                            <td>".$row['spa_rate']."</td>
                                            <td class='text-center'><i class='fa fa-edit'></i> <i class='fa fa-trash' style='margin-left: 15px;'></i></td>
                                            </tr>";										
										}
